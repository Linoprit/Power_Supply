...
#ifndef DEVICES_ROTARY_ENCODER_BUTTON_STATE_MACHINE_H_
#define DEVICES_ROTARY_ENCODER_BUTTON_STATE_MACHINE_H_
...
#endif /* DEVICES_ROTARY_ENCODER_BUTTON_STATE_MACHINE_H_ */
